...
function App() {
  ...
  return (
    <Router>
      <div className="App">
        {/* A MUDANÇA ESTÁ AQUI: Passamos o objeto 'user' para a Navbar */}
        {user && <Navbar user={user} handleLogout={handleLogout} toggleTheme={toggleTheme} currentTheme={theme} />}
              ...
              <>
                ...
                {user.role === 'company' && (
                  <>
                    ...
                    <Route path="/job/:jobId/candidates" element={<ManageCandidatesPage />} />
                  </>
                )}
